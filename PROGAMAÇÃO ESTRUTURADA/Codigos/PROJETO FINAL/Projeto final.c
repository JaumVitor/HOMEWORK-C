//Obs, erro com valores exatos ---> alterar valor de saldo para double
#include <stdio.h> 
#include <stdlib.h>
#include <conio.h> 
#include <locale.h>
...
void inf_Relatorio (cliente listaCliente[], conta listaConta[], int *pos, int *cont); 
...
void Listar2 (conta listaConta[], cliente listaCliente[], int *cont, int *pos);
void Listar3 (cliente listaCliente[], int *pos); //listar todos Cliente
void Listar4 (conta listaConta[], cliente listaCliente[], int *cont, int *pos); //listar todas as contas 
void Listar5 (conta listaConta[], cliente listaCliente[], int *cont, int *pos);
...
int main (){
	...
	do{
		...
		case 3: 
			...
			break ; 
		case 4: 
			system("cls"); inf_Relatorio (listaCliente, listaConta, &pos, &cont);
			break ; 
		case 0: 
			break ; 
		default: 
...
void inf_Relatorio (cliente listaCliente[], conta listaConta[], int *pos, int *cont){
	...
	do{
		...
		case 1: 
			...
			break ; 
		case 2:
			Listar2 (listaConta, listaCliente, &*cont, &*pos); system("pause"); 
			break; 
		case 3: 
			Listar3 (listaCliente, &*pos); system("pause"); 
			break; 
		case 4: 
			Listar4 (listaConta, listaCliente, &*cont, &*pos); system("pause"); 
			break; 
		case 5: 
			Listar5 (listaConta, listaCliente, &*cont, &*pos); system("pause"); 
			break; 
		case 6: 
...
void Listar2 (conta listaConta[], cliente listaCliente[], int *cont, int *pos){ //FUNÇÃO QUE PODE SALVAR DADOS COMO ARQUIVO TXT
	double valorAnalise; 
	int esc, id, i;
	...
	scanf ("%lf", &valorAnalise);
 	...
 	if (*cont != 0){
		...
		printf ("NÃO EXISTE CONTAS FAZER LISTAMENTO"); 
	}	 	 
}

void Listar3 (cliente listaCliente[], int *pos){ //DEVE SALVAR ARQUIVO TXT
...
void Listar4 (conta listaConta[], cliente listaCliente[], int *cont, int *pos){ //DEVE SALVAR ARQUIVO TXT
...
void Listar5 (conta listaConta[], cliente listaCliente[], int *cont, int *pos){ //DEVE SALVAR ARQUIVO TXT
